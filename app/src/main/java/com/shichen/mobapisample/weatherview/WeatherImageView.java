...
public class WeatherImageView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private static class CityDraw {
        ...
        private void draw(Canvas canvas, float heightF, int startX) {
            ...
            path.lineTo(startX + 20, heightF - 460.0f);
            path.lineTo(startX + 40, heightF - 460.0f);
            path.lineTo(startX + 40, heightF - 510.0f);
            path.lineTo(startX + 60, heightF - 510.0f);
            path.lineTo(startX + 60, heightF - 530.0f);
            path.lineTo(startX + 80, heightF - 560.0f);
            path.lineTo(startX + 120, heightF - 560.0f);
            path.lineTo(startX + 140, heightF - 560.0f);
            path.lineTo(startX + 80 + 80, heightF - 530.0f);
            path.lineTo(startX + 80 + 80, heightF - 510.0f);
            path.lineTo(startX + 80 + 100, heightF - 510.0f);
            path.lineTo(startX + 80 + 100, heightF - 460.0f);
            path.lineTo(startX + 80 + 120, heightF - 460.0f);
            path.lineTo(startX + 80 + 120, heightF - 420.0f);
            path.lineTo(startX + 80 + 140, heightF - 420.0f);
            path.lineTo(startX + 80 + 140, heightF + 100.0f);
            path.close();
            canvas.drawPath(path, mPaint);
            Path build2 = new Path();
            build2.moveTo(startX + 160, heightF + 100.0f);
            build2.lineTo(startX + 160, heightF - 210.0f);
            build2.lineTo(startX + 400, heightF - 210.0f);
            build2.lineTo(startX + 400, heightF + 100.0f);
            build2.close();
            canvas.drawPath(build2, mPaint);
            Path build3 = new Path();
            build3.moveTo(startX + 260, heightF + 100.0f);
            build3.lineTo(startX + 260, heightF - 240.0f);
            build3.lineTo(startX + 275, heightF - 240.0f);
            build3.lineTo(startX + 275, heightF - 260.0f);
            build3.lineTo(startX + 295, heightF - 260.0f);
            build3.lineTo(startX + 295, heightF - 280.0f);
            build3.lineTo(startX + 325, heightF - 280.0f);
            build3.lineTo(startX + 325, heightF - 260.0f);
            build3.lineTo(startX + 345, heightF - 260.0f);
            build3.lineTo(startX + 345, heightF + 100.0f);
            build3.close();
            ...
            build4.lineTo(startX + 405, heightF - 240.0f);
            build4.lineTo(startX + 405, heightF - 360.0f);
            build4.lineTo(startX + 445, heightF - 360.0f);
            build4.lineTo(startX + 445, heightF - 440.0f);
            build4.lineTo(startX + 465, heightF - 440.0f);
            build4.lineTo(startX + 495, heightF - 470.0f);
            build4.lineTo(startX + 525, heightF - 470.0f);
            build4.lineTo(startX + 525, heightF - 510.0f);
            build4.lineTo(startX + 645, heightF - 510.0f);
            build4.lineTo(startX + 645, heightF - 470.0f);
            build4.lineTo(startX + 725, heightF - 390.0f);
            build4.lineTo(startX + 725, heightF - 270.0f);
            build4.lineTo(startX + 745, heightF - 270.0f);
            build4.lineTo(startX + 745, heightF - 250.0f);
            build4.lineTo(startX + 755, heightF - 250.0f);
            build4.lineTo(startX + 755, heightF - 150.0f);
            build4.lineTo(startX + 815, heightF - 150.0f);
            build4.lineTo(startX + 815, heightF - 120.0f);
            build4.lineTo(startX + 815, heightF + 100.0f);
            //815
            build4.close();
            ...
            build5.lineTo(startX + 915, heightF - 100.0f);
            build5.lineTo(startX + 915, heightF + 100.0f);
            build2.close();
            canvas.drawPath(build5, mPaint);
            Path build6 = new Path();
            build6.moveTo(startX + 855, heightF + 100.0f);
            build6.lineTo(startX + 855, heightF - 135.0f);
            build6.lineTo(startX + 905, heightF - 135.0f);
            build6.lineTo(startX + 905, heightF - 135.0f - 450.0f);
            build6.lineTo(startX + 925, heightF - 135.0f - 450.0f);
            build6.lineTo(startX + 925, heightF - 135.0f - 450.0f - 90.0f);
            build6.lineTo(startX + 1005, heightF - 135.0f - 450.0f - 90.0f);
            build6.lineTo(startX + 1005, heightF - 135.0f - 450.0f - 90.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10, heightF - 135.0f - 450.0f - 90.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10 + 40, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10 + 40, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f - 15.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f - 15.0f - 15.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f - 15.0f - 15.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f - 15.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f - 15.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10, heightF - 135.0f - 450.0f - 90.0f - 20.0f - 20.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10, heightF - 135.0f - 450.0f - 90.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30, heightF - 135.0f - 450.0f - 90.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30, heightF - 135.0f - 450.0f - 90.0f - 120.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20, heightF - 135.0f - 450.0f - 90.0f - 120.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f - 40.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f - 40.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f - 30.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f - 70.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30 + 90, heightF - 135.0f - 450.0f - 90.0f - 120.0f - 200.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30 + 90, heightF - 135.0f - 450.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30 + 90 + 250, heightF - 135.0f - 450.0f);
            build6.lineTo(startX + 1005 - 10 + 40 + 20 + 120 + 20 + 10 + 30 + 20 + 60 + 40 + 40 + 120 + 40 + 30 + 90 + 250, heightF + 100.0f);
            build6.close();
